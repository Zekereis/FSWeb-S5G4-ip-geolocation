...
function cardOlustur(veri) {
  ...
  pUlke.textContent = "".concat(veri["ülke"], "(").concat(veri["ülkeKodu"], ")");
  pEnlem.textContent = "Enlem: ".concat(veri["enlem"], " Boylam: ").concat(veri["boylam"]);
  pSehir.textContent = "\u015Eehir: ".concat(veri["şehir"]);
  pSaat.textContent = "Saat dilimi:".concat(veri["saatdilimi"]);
  pPara.textContent = "Para birimi: ".concat(veri["parabirimi"]);
  pIsp.textContent = "ISP: ".concat(veri["isp"]);
